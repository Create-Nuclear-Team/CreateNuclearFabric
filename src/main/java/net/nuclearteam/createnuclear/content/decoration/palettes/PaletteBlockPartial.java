...
public abstract class PaletteBlockPartial<B extends Block> {
    ...
    public static final Supplier<PaletteBlockPartial<SlabBlock>> UNIQUE_SLAB = () -> new Slab(true);
    public static final Supplier<PaletteBlockPartial<WallBlock>> WALL = Wall::new;

    public static final PaletteBlockPartial<?>[] ALL_PARTIALS = { STAIR.get(), SLAB.get(), WALL.get() };
    public static final PaletteBlockPartial<?>[] FOR_POLISHED = { STAIR.get(), UNIQUE_SLAB.get(), WALL.get() };
    ...
    protected abstract void createRecipes(CNPaletteStoneTypes type, BlockEntry<? extends Block> patternBlock, DataGenContext<Block, ? extends Block> c,
